jest.mock('@/src/settings/db', () => ({
  loadSettings: jest.fn(),
  saveSettings: jest.fn(async () => undefined),
}));

jest.mock('@/src/i18n', () => {
  const actual = jest.requireActual('@/src/i18n') as typeof import('@/src/i18n');
  return {
    ...actual,
...
import { loadSettings, saveSettings } from '@/src/settings/db';
import { readSystemLocale, setLocale as applyI18nLocale } from '@/src/i18n';
